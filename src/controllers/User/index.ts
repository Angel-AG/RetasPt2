...
router.post('/logout', asyncHandler(isLoggedIn), asyncHandler(UserController.logout())); 
...
router.get('/get_logged_in_user/', asyncHandler(isLoggedIn), asyncHandler(UserController.getUser()));
